                ...
                <div>
                    <div className="flex items-center justify-between py-0 md:py-0 md:block">
                        <a href="/home">
                            ...
                            <img className="md:h-16 mt-2 md:w-40 h-12 w-28" src="https://lh5.googleusercontent.com/Tf0uHV8l4JfDG29oLIaH02HwHb7lp02rm5VZgm90z29xz69a9wJ7NGwjjldAorrauiI=w2400" alt="nav_logo" />
