  ...
  return (
    <>
      ...
      <div className='text-div max-[1100px]:mt-28 '>
        <p className='w-auto p-10 mr-2 amity-text text-white font-bold text-3xl max-[678px]:text-xl'>Amity Univesity Patna </p>
        <p className='amiphoria-text max-[678px]:text-7xl text'>AMIPHORIA 2023</p>
        <p className='mb-10 font-[Kanit] text-xl max-[678px]:text-md'>Come join us as we celebrate and indulge in the joys of life and competition. This is not just a fest but an expression of liveliness and art forms. The biggest celebration of art in Bihar. Amiphoria comes with a promise to break the monotony, to give you an opportunity to recharge meet and bond with anyone and everyone who shares your passion for any kind of art.</p>
