  ...
  return (
    <section data-aos="flip-down" className="bg-white dark:bg-gray-900 h-[555px] mt-10 mb-8 max-[768px]:m-auto max-[768px]:mb-4 rounded-2xl max-[900px]:mr-2">
      <div className="py-8 lg:py-4 px-6 mx-auto max-w-screen-md flex flex-col items-center">
        ...
        <form ref={form} onSubmit={sendEmail} action="/events" className="space-y-8">
          <div>
            <label htmlFor="number" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Your Phone Number</label>
          ...
          <div>
            ...
            <input type="text" id="name" name="user_name" className="block p-3 w-96 max-[768px]:w-72 text-sm text-gray-900 bg-[#f0eeee] rounded-lg border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="Tell Your Name" required />
          </div>
          <div className="sm:col-span-2">
            <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Your message</label>
            <textarea id="message" name="message" rows="4" className="block p-2 w-96 max-[768px]:w-72 text-sm text-gray-900 bg-[#f0eeee] rounded-lg shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Leave a message..."></textarea>
          </div>
          <button type="submit" value="Send" className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-[#3497FE] hover:bg-[#0458f4] hover:-translate-y-0.5 transition-all delay-75 sm:w-fit ">
