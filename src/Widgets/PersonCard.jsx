...
export default function PersonCard({ image, name, role, profileLink }) {
  ...
  return (
    <div
      ...
      className="flex transition-all   delay-100 ease-in-out align-center flex-col person-card-base rounded-xl text-black"
    >
      <div className=" transition-all delay-100 ease-in-out profile-parent rounded-full border-inherit border-2 p-1 cursor-pointer">
        <div
          className={` p-5 absolute top-5 z-1 transition-all delay-100 ease-in-out ${
            hovered ? "translate-y-[-7rem]" : ""
          }`}
        >
        ...
        <img
          ...
          src={image}
          className="rounded-full user-image z-2 absolute "
          alt=""
        />
      </div>
